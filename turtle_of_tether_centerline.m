...
for i=1:size(objects,1)
    plot(objects(i,1),objects(i,2),'rs','MarkerSize',12); hold on;
end
startPose = [10 5 pi/2]; 
endPose= [140 5 -pi/2];
S=[5,5,pi/2,15,5,pi/2];
E=[145,5,-pi/2,135,5,-pi/2];
plot(5,5,'m.','Markersize',12);plot(15,5,'m.','Markersize',12);
plot(135,5,'m.','Markersize',12);plot(145,5,'m.','Markersize',12)

waypoints=[]; circles=[];
[c,r]=minboundcircle(objects(5:6,1),objects(5:6,2));
waypoints=[waypoints;c];
circles=[circles;[c r+4]];
plot_circle(c,r+4);
